...
Уроки:
    ...
    1.ПРОДВИНУТЫЙ PANDAS И ЗНАКОМСТВО С ВИЗУАЛИЗАЦИЕЙ НА PYTHON  
  4. РАБОТА С ГРЯЗНЫМИ ДАННЫМИ
  5. ВРЕМЯ И СВОДНЫЕ ТАБЛИЦЫ
  6. ОКОННЫЕ ФУНКЦИИ И ИНТЕРАКТИВНЫЕ ГРАФИКИ
  7. API (GOOGLE SPREADSHEETS, ЯНДЕКС.МЕТРИКА)
  8. ПРОДВИНУТЫЕ ТЕМЫ PANDAS И ЗАДАНИЯ СО ЗВЁЗДОЧКОЙ 
