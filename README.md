...
3. SQL - освоим основы синтаксиса SQL. На примере ClickHouse научимся работать с системой управления базами данных и подключаться к ней с помощью Python. Начнем учиться грамотно визуализировать наши данные.  
Уроки:
